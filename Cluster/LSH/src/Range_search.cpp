...
void Range_search(Cluster** cluster, HashTable **hashTables, std::vector<std::vector<int>> &g, std::vector<double> &query, std::vector<int> &fi, int &L, int &k, double &R, bool Euclidean, double &TrueDist)
{
	int tmpfi;
