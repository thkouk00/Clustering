...
void Lloyds_Assignment(std::map<std::vector<double>, std::vector<double>>&, Cluster **, std::vector<std::vector<double>>&, std::vector<std::vector<double>>&, std::vector<std::string>&, bool&);
