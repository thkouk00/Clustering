...
void cube_search_neighbors(std::map<std::vector<double>, MapNode>&, cube_HashTable*, std::vector<std::string>&, std::vector<std::vector<double>>&, std::map<int,bool>&, int&, int&, int&, int&, int&, bool&);
