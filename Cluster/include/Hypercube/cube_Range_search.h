...
void cube_Range_search(std::map<std::vector<double>, MapNode>&, cube_HashTable*, std::vector<int>&, std::vector<double>&, std::vector<std::vector<double>>&, int&, int&, int&, int&, double&, bool, bool&, int&);
#endif