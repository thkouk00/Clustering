...
void Lloyds_Assignment(std::map<std::vector<double>, std::vector<double>>& map, Cluster **cluster, std::vector<std::vector<double>>& Points, std::vector<std::vector<double>>& Cluster_Table, std::vector<std::string>& point_id)
{
...
void LSH_Assignment(HashTable** hashTables, Cluster **cluster, std::vector<std::vector<double>>& Points, std::vector<std::vector<double>>& Cluster_Table, std::vector<std::string>& point_id, int& k_lsh, int& L, int& w)
{
	//clean structure
	for (int i=0;i<Cluster_Table.size();i++)
	{
	...
	Search_Neighbors(hashTables, cluster, Points, Cluster_Table, point_id, k_lsh, L, w);
}
